...
import com.haerul.mapples.data.api.ApiInterface;
...
public class AppModule {
    ...
    @Provides @Singleton Interceptor provideLoggingInterceptor() {
    ...
    @Provides @Singleton OkHttpClient provideOkHttp(App application) {
    ...
    @Provides @Singleton Retrofit provideRetrofitClient(App application) {
